			...
			<form id="form1">
				<div class="form-1" id="1">
					...
					<div id="11">
                        ...
                        <label class="containercheck">
                            <input type="checkbox" name="q21" id="test123" value="1" checked='checked'>
                            <span class="checkmark"></span>
                            Sport
                        </label>
                        <label class="containercheck">
                            <input type="checkbox" name="q22" id="test123" value="2" checked='checked'>
                            <span class="checkmark"></span>
                            History
                        </label>
                        <label class="containercheck">
                            <input type="checkbox" name="q23" id="test123" value="3" checked='checked'>
                            <span class="checkmark"></span>
                            Nature
                        </label>
					</div>
				...
				<div class="form-1" id="2">
					<div class="form-area">
                        ...
                        <label class="containercheck">
                            <input type="checkbox" name="q3" class='q3' value="public" checked='checked'>
                            <span class="checkmark"></span>
                            Public
                        </label>
                        <label class="containercheck">
                            <input type="checkbox" name="q3" class='q3' value="private" checked='checked'>
                            <span class="checkmark"></span>
                            Private
                        </label>
						<br>
