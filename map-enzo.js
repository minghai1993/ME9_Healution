...
<script
 src="https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js">
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAyFJft-jNj7_wcp56wVfEvdem46_p8-XE&language=en&region=AU&callback=initMap"></script>
<h3 id="test">Search by themes</h3>
<div id="main-area">
<div class="table-present-1">
<div id="map">&nbsp;</div>
</div>
<div class="table-present-2"><fieldset id="legend"><legend>Filter</legend>
...
<p>Suburb: <input id="suburb" name="suburb" type="text" placeholder="Enter your preferred suburb name"></p>
<legend>Theme</legend>
Art:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img id="icon_art" class="img" src="https://healution.tk/wp-content/uploads/2019/04/art-e1554804124459.png"> <label onclick="handleSubmit('art')"><input id="checkArt" checked="checked" type="checkbox" data-toggle="toggle"></label>
<br><br>
<p>Fountain:&nbsp;&nbsp;<img id="icon_fountain" class="img" src="https://healution.tk/wp-content/uploads/2019/04/new_fountain-e1554968248774.png">   <label onclick="handleSubmit('drinkingFountain')"><input id="checkFt" checked="checked" type="checkbox" data-toggle="toggle"></label>
<br><br>
Monument:<img id="icon_monument" class="img" src="https://healution.tk/wp-content/uploads/2019/04/monument.png">
<label onclick="handleSubmit('monument')"><input id="checkMon" checked="checked" type="checkbox" data-toggle="toggle"></label>
<p><input id="button" class="button" type="button" value="Show" onclick="handleSubmit()"></p>
</fieldset>
