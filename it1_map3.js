...
<h3 id='test'>Map</h3>
    ...
    <fieldset id = 'legend'>
        ...
        <div>
        Surburb: <input type='text' name='suburb' id='suburb' placeholder="please enter your suburb name">
        </div>
            <legend>Marker</legend>
            <div>&nbsp;&nbsp;&nbsp;Art: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <input type='image' src='https://healution.tk/wp-content/uploads/2019/04/art-e1554804124459.png' id='icon_art' class='img' onclick="handleSubmit('art');return false">
                    <label onclick="handleSubmit('art')">
                      <input type="checkbox" id='checkArt' data-toggle="toggle" checked>
                    </label></div>
            <br></br>
            <div>Fountain: &nbsp; &nbsp; &nbsp;
            <input type='image' src='https://healution.tk/wp-content/uploads/2019/04/new_fountain-e1554968248774.png' id='icon_fountain' class='img'
                onclick="handleSubmit('drinkingFountain');return false">
                <label onclick="handleSubmit('drinkingFountain')">
                        <input type="checkbox" id='checkFt' data-toggle="toggle" checked>
                      </label>
                      <br></br></div>
                      <div>Monument:
            <input type='image' src='https://healution.tk/wp-content/uploads/2019/04/monument.png' id='icon_monument' class='img'
                onclick="handleSubmit('monument');return false">
    ...
    <p id='alert'>The number in the marker idicates the density of that area</p>
...
function displayTable(row) {
    ...
    if (ftArr.length >= 1) {
        ...
        output += "<div id = 'ftOutput' class = 'output tab-pane fade'><h3 id = 'header'>Fountain</h3><table class='table'><thead><tr><th scope='row'>Fountain</th><th scope='row'>Name</th><th scope='row'>Type</th><th scope='row'>Suburb</th><th scope='row'>Postcode</th></tr></thead>";

        for (var i = 0; i < ftArr.length; i++) {
            output += "<tr><td>" + ftArr[i].D1 + "</td><td>" + ftArr[i].D2 + "</td><td>" + ftArr[i].D3 + "</td><td>" + ftArr[i].Suburb + "</td><td>" + ftArr[i].Postcode + "</td></tr>"
        }
        output += '</table></div>'
    }else{
