			...
			<form id="form1">
				<div class="form-1" id="1">
					<div class="form-area">
						...
						<input type="radio" name="q1" class='q11' id="q13" value="3">Both<br>
					</div>
					<div id="11">
						<br>
						<h3>
					...
					<div class="next-button" style="margin-top:40px;">
				...
				<div class="form-1" id="2">
					<div class="form-area">
						...
						<input type="checkbox" name="q3" class='q3' value="public">Public<br>
						<input type="checkbox" name="q3" class='q3' value="private">Private<br>
						<br>
					</div>
					<div class="back-button">
						<button id="back" class="back-1" onclick="handleClickBack();return false">Back</button>
					</div>
...
<script>
    ...
    function printResult(arr) {
        ...
        var checklists = "<h2 style='display:none'>Always Cherie</h2><table id ='printCheck' class='table table-striped'><tr><th>Checklist</th><th><button id = 'cmd' onclick='printPdf();return false'>Download</button></th></tr></table>"
        ...
        if (arr.length > 0) {
            ...
            // var checklist = "<table id ='printCheck' class='table table-striped'><tr><th>Checklist</th><th>Delete</th></tr>"
        ...
        if(ifPublic){
			for(var i = 0;i < new_bus.length;i++){
				...
				marker = new google.maps.Marker({
					position: myLatLng,
					map: checklistMap,
					icon: 'https://www.alwayscherie.ml/wp-content/uploads/2019/04/Bus-Marker-e1556385118473.png'
				});
			}
			for(var i = 0;i < new_tram.length;i++){
				...
				marker = new google.maps.Marker({
					position: myLatLng,
					map: checklistMap,
					icon: 'https://www.alwayscherie.ml/wp-content/uploads/2019/04/Tram-Marker-e1556385190132.png'
				});
			}
			for(var i = 0;i < new_railwayStation.length;i++){
				...
				marker = new google.maps.Marker({
					position: myLatLng,
					map: checklistMap,
					icon: 'https://www.alwayscherie.ml/wp-content/uploads/2019/04/Train-Marker-e1556385147530.png'
				});
			}
		}
    }
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAyFJft-jNj7_wcp56wVfEvdem46_p8-XE&language=en&region=AU&callback=initCheckListMap"></script>
<script>
